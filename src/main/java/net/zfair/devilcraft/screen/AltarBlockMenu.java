package net.zfair.devilcraft.screen;
...
public class AltarBlockMenu extends AbstractContainerMenu {
    ...
    public AltarBlockMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 80, 32));
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 138, 32));
        });
